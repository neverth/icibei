...
import fun.neverth.icibei.organization.entity.form.ResourceForm;
import fun.neverth.icibei.organization.entity.form.ResourceQueryForm;
...
public class ResourceController {
    ...
    public Result queryByUsername(@PathVariable String userId) {
        log.debug("query with username:{}", userId);
