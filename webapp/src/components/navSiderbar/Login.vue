   ...
   <div class="sidebar-header">
     ...
     <p style="opacity: 1">没有账号？<a href="#" @click="registerTips">点击注册</a></p>
       <div class="form-group">
         <label>请输入账号：</label>
         <input required="required" id="username" type="text" class="form-control" placeholder="account" name="account">
       </div>
       <div class="form-group" style="position: relative">
         ...
         <input required="required" id="passw" type="password" class="form-control" placeholder="Password" name="password">
       </div>
       ...
       <button @click="submitE" id="registerButton" type="submit" class="btn btn-primary">登录
       </button>
   </div>
 </template>
